...
public class HomeActivity extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (btAdapter == null) {
            ...
            Toast.makeText(HomeActivity.this, "we're done", Toast.LENGTH_SHORT).show();
        }
        else {
            Toast.makeText(HomeActivity.this, "keep going", Toast.LENGTH_SHORT).show();
        }
    ...
    protected void onStart() {
            ...
            public void onClick(View view) {
                if(check) {
                    if(ContextCompat.checkSelfPermission(HomeActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)==PackageManager.PERMISSION_DENIED)
                        ActivityCompat.requestPermissions(HomeActivity.this, new String[] {Manifest.permission.WRITE_EXTERNAL_STORAGE},GIVE_PERMISSIONS);
                    else {
                        PickImage();
                    }
                } else {
                    if(ContextCompat.checkSelfPermission(HomeActivity.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                        ActivityCompat.requestPermissions(HomeActivity.this, new String[]{Manifest.permission.CAMERA}, GIVE_PERMISSIONS);
                    }
                    else {
                        TakePicture();
                    }
        ...
        rec.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(HomeActivity.this, "It is clickable!", Toast.LENGTH_LONG).show();
                                ...
                                .addOnFailureListener(
                                        new OnFailureListener() {
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                Toast.makeText(HomeActivity.this, "Something goes wrong!", Toast.LENGTH_LONG).show();
                                            }
                                        });
            }
        });
